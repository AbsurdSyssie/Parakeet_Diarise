#!/usr/bin/env python3
"""Transcribe a short clip with Parakeet and print timestamps."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Transcribe a WAV clip with Parakeet and print timestamps."
    )
    parser.add_argument(
        "audio_path",
        nargs="?",
        default="Output/MoreOrLess_30s.wav",
        help="Path to WAV clip (default: Output/MoreOrLess_30s.wav)",
    )
