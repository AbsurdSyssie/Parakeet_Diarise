# Legacy Parakeet deployment guide

This document is retained for historical context. It predates the current application structure and contains obsolete environment guidance, including Python 3.11 recommendations and an older Docker setup.

For current usage, see `../parakeet.md`, `../api.md`, and the repository `Dockerfile`.
